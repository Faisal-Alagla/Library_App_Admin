            ...
            <div class="container p-0">
                <div class="row d-flex justify-content-center align-items-center h-100 p-0">
                    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                        <form class="card shadow-lg" style="border-radius: 20px" method="post" action="../db/login_action.php">
                            <div class="card-body p-5 text-center">
                                ...
                                <div class="mb-4 text-start">
                                    <div class="input">
                                        ...
                                        <input type="text" id="email" name="email" class="form-control form-control-lg shadow-lg" aria-describedby="basic-addon1" style="border-radius: 15px" required />
                                    ...
                                    <div class=" mb-3 mt-3 text-start input">
                                        ...
                                        <input type="password" id="password" name="password" class="form-control form-control-lg shadow-lg " style="border-radius: 15px; padding-right: 40px;" required />
                                ...
                                <button class="btn btn-lg btn-block text-white w-50 display-2 mb-3 " style="background-color: #212B5E; border-radius: 15px" type="login" name="login">Login</button>
                            </div>
                        </form>
                    </div>
                </div>
