                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="mb-4 text-start">
                                ...
                                <div class=" mb-3 mt-3 text-start input">
                                    ...
                                    <input type="text" id="isbn" name="isbn" class="form-control form-control-lg shadow-lg " style="border-radius: 15px; padding-right: 40px;" minlength="10" maxlength="13" required />
                            ...
                            <button class="btn btn-lg btn-block text-white w-50 display-2 mb-3 " style="background-color: #212B5E; border-radius: 15px" type="add_book" name="add_book">Add</button>
                        </div>
                    </form>
                </div>
            </div>
