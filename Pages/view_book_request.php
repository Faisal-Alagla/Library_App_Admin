        ...
        <div class="container p-0">
            <div class="row d-flex justify-content-center align-items-center h-100 p-0">
                <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                    <form class="card shadow-lg" style="border-radius: 20px" method="post" action="../db/book_request_action.php" enctype="multipart/form-data">
                        <div class="card-body p-5 d-flex flex-column text-center align-items-center">
                                ...
                                ?>
                                    ...
                                    <div class="mb-4 text-start w-100">
                                        ...
                                        <div class=" mb-3 mt-3 text-start input">
                                            ...
                                            <input type="text" id="isbn" name="isbn" class="form-control form-control-lg shadow-lg " style="border-radius: 15px; padding-right: 40px;" minlength="10" maxlength="13" value="<?php echo $book['isbn'] ?>" required />
                                        ...
                                        <div class="col-sm-12 d-flex flex-row justify-content-center align-items-center mt-3" style="border: 1px solid #212B5E; border-radius: 15px;">
                                            <div class="input col-sm-3">
                                                ...
                                                <input type="hidden" id="image" name="image" class="form-control form-control-lg shadow-lg" aria-describedby="basic-addon1" value="<?php echo $book['image'] ?>" style="border-radius: 15px" />
                                        ...
                                        <div class=" mb-3 mt-3 text-start input">
                                            ...
                                            <textarea type="input" name="summary" rows="10" id="summary" class="form-control form-control-lg shadow-lg rows" value="<?php echo $book['summary'] ?>" style="border-radius: 15px;"><?php echo $book['summary'] ?></textarea>
                                        </div>
                                        <!-- Summary Field end -->
                            ...
                            <div class="col-sm-12 row justify-content-center align-self-center">
                                <div class="col-sm-6 px-1">
                                    <button class="btn btn-lg btn-block text-white w-100 display-2 mb-3" style="background-color: #212B5E; border-radius: 15px" name="accept_request" type="accept_request">
                                        Accept
                                    </button>
                                </div>
                                <div class="col-sm-6 px-1">
                                    <button class="btn btn-lg btn-block text-white w-100 display-2 mb-3 " style="background-color: #98030e; border-radius: 15px" name="decline_request" type="decline_request">
                                        Decline
                                    </button>
                                </div>
                            </div>
