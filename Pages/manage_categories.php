                        ...
                        <div class="card-body p-5 pb-2 text-center">
                            ...
                            <form class="col-sm-12 d-flex flex-row justify-content-center align-items-center mb-3" method="post" action="../db/manage_categories_action.php">
                                ...
                                <label class="form-label" for="category" style="color:#212B5E;">Category</label>
                                    <input type="text" id="category" name="category" class="form-control form-control-lg shadow-lg w-75" aria-describedby="basic-addon1" value="" style="border-radius: 15px; padding-left: 5px; padding-right: 5px;" required />
                                </div>
                                <!-- <div class="col-sm-4 d-flex flex-row justify-content-evenly align-items-center input text-start">
                            ...
                            ?>
                                    ...
                                    <form class="col-sm-12 d-flex flex-row justify-content-center align-items-center mb-3" method="post" action="../db/manage_categories_action.php">
                                        ...
                                        <div class="col-sm-3 d-flex flex-row justify-content-center align-items-center align-self-end mx-1">
                                            <button class="btn btn-lg btn-block text-white display-2 w-100" style="background-color: #212B5E; border-radius: 15px" type="update_category" name="update_category">Update</button>
                                        </div>
                                        <div class="col-sm-3 d-flex flex-row justify-content-center align-items-center align-self-end mx-1">
                                            <a class="btn btn-lg btn-block text-white display-2 w-100" style="background-color: #98030e; border-radius: 15px" href="manage_categories.php">Cancel</a>
                                        </div>
                                    </form>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-sm text-white w-100" style="background-color: #98030e; border-radius: 5px" data-bs-toggle="modal" data-bs-target="#<?php echo $key ?>">
                                                                Delete
                                                            </button>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="<?php echo $key ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <h5>Deleting this category will delete the category attribute of <span class="text-danger fw-bold">ALL BOOKs</span> that are categorized as <span class="fw-bold"><?php echo '"' . $row['category'] . '"'; ?></span></h5>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Abort</button>
                                                                    <a type="button" class="btn text-light" style="background-color: #98030e; border-radius: 5px" href="../db/manage_categories_action.php?delete_id=<?php echo $key ?>">Delete anyway</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
