            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                    <li class="nav-item px-2">
                        <a class="nav-link <?php if ($cur_page == 'home.php') echo $active; ?>" aria-current="page"
                            href="home.php">Home</a>
                    </li>
                    <li class="nav-item px-2">
                        <a class="nav-link <?php if ($cur_page == 'borrowers.php') echo $active; ?>"
                            href="borrowers.php">Borrowers</a>
                    </li>
                    <li class="nav-item dropdown px-2">
                        <a class="nav-link dropdown-toggle <?php echo $actions_active ?> " href="#"
              ...
              <li><a class="dropdown-item" href="#">Something else here</a></li> -->
                    ...
                    <li class="nav-item px-2">
                        <a class="position-relative nav-link <?php if ($cur_page == 'book_requests.php') echo $active; ?>"
                            href="book_requests.php" tabindex="-1" aria-disabled="true">
                            Book Requests
              ...
              ?>
                ...
                <div class="d-flex flex-row">
                    <div class="d-flex mx-2" method="post" action="#">
                        <a class="btn btn-outline-light <?php if ($cur_page == 'profile.php') echo $active; ?>"
